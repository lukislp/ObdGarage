...
// Runs the same cases as tests/ObdGarage.Tests — there as xunit, at home for `dotnet test`.
using ObdGarage.Obd;
...
await ObdGarage.TestRunner.E2ETests.RunAsync(Check, (n, e, a, t) => CheckEqual(n, e, a, t));
await ObdGarage.TestRunner.SyncTests.RunAsync(Check);
await ObdGarage.TestRunner.SecurityTests.RunAsync(Check);
